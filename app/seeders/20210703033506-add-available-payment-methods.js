...
module.exports = {
  up: async (queryInterface) => {
    const paymentMethodIdData = [
      '60627261-4e6c-4ebf-8879-914576ade417',
      '7f3869c1-7dc9-4486-9045-6bade487a49d',
    ...
    const productIdData = [
      'b405ea1c-b2f5-48a3-a9a9-3af2deb9708a', '529c372e-55d4-4874-af2d-a5cfdf16aa96', '4b426920-f017-4ad7-a645-fd94101e9dc4',
    ...
    const availablePaymentMethodsData = [];

    for (let i = 0; i < 80; i += 1) {
      const payment_methodId = paymentMethodIdData[
        Math.floor(Math.random() * paymentMethodIdData.length)
      ];
      const productId = productIdData[Math.floor(Math.random() * productIdData.length)];
      availablePaymentMethodsData.push({
        payment_methodId,
        productId,
        createdAt: new Date(),
        updatedAt: new Date(),
    ...
    return queryInterface.bulkInsert('available_payment_methods', availablePaymentMethodsData);
  },

  down: async (queryInterface) => {
    await queryInterface.bulkDelete('available_payment_methods', null, {});
  },
};
